...
topology<span class="token punctuation">.</span><span class="token function">addPen</span><span class="token punctuation">(</span>pen<span class="token punctuation">)</span><span class="token punctuation">;</span>
topology<span class="token punctuation">.</span><span class="token function">inactive</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><ul><li>\u6570\u636E\u66F4\u65B0 \u901A\u5E38\u6765\u8BB2\uFF0Cecharts \u62D6\u62FD\u5230\u753B\u5E03\u540E\uFF0C\u53EA\u5173\u6CE8\u5B83\u7684\u6570\u636E\u53D8\u5316\uFF0C\u5373 x \u8F74\u7684\u53D8\u5316\uFF0C\u5355\u6761\u7EBF\uFF08\u6216\u591A\u6761\u7EBF\uFF09\u503C\u7684\u53D8\u5316\u3002<br> \u800C setValue \u5904\u7406\u8D77\u6765\uFF0C\u6BCF\u6B21\u90FD\u9700\u8981\u66F4\u6539 echarts.options \u4E0B\u7684\u5168\u90E8\u503C\uFF0C\u5BF9\u4E8E\u7528\u6237\u6765\u8BF4\uFF0C\u8FC7\u4E8E\u590D\u6742\uFF0C\u4E8E\u662F\u63D0\u4F9B\u4E86\u4E00\u79CD\u56FA\u5B9A\u7684\u89C4\u5219\u5904\u7406\u3002<br> \u5F53\u7136 mqtt \u4E0E ws \u7684\u9ED8\u8BA4\u5904\u7406\u4E5F\u662F\u901A\u8FC7 setValue \u7684\uFF0C\u6EE1\u8DB3\u4E0B\u9762\u6761\u4EF6\uFF0C\u53EF\u53EA\u5173\u6CE8\u6570\u636E\u7684\u53D8\u5316\u3002</li></ul><div class="language-ts"><pre><code><span class="token comment">/**
 * \u56FE\u8868\u8FFD\u52A0\u6216\u66FF\u6362\u6570\u636E\uFF0C\u53EA\u5173\u6CE8\u6570\u636E
 */</span>
...
topology<span class="token punctuation">.</span><span class="token function">setValue</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  dataY<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token number">500</span><span class="token punctuation">,</span> <span class="token number">600</span><span class="token punctuation">]</span>
...
topology<span class="token punctuation">.</span><span class="token function">setValue</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  id<span class="token operator">:</span> <span class="token string">&#39;le5le&#39;</span><span class="token punctuation">,</span>
  dataX<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;eight&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;nine&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
  dataY<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token punctuation">[</span><span class="token number">500</span><span class="token punctuation">,</span> <span class="token number">300</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token punctuation">[</span><span class="token number">700</span><span class="token punctuation">,</span> <span class="token number">400</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token punctuation">[</span><span class="token number">300</span><span class="token punctuation">,</span><span class="token number">1200</span><span class="token punctuation">]</span><span class="token punctuation">,</span><span class="token punctuation">[</span><span class="token number">600</span><span class="token punctuation">,</span><span class="token number">1200</span><span class="token punctuation">]</span><span class="token punctuation">,</span><span class="token punctuation">[</span><span class="token number">400</span><span class="token punctuation">,</span><span class="token number">50</span><span class="token punctuation">]</span><span class="token punctuation">]</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
...
topology<span class="token punctuation">.</span><span class="token function">inactive</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div>`,43),e=[o];function c(u,l,r,k,i,d){return a(),s("div",null,e)}var h=n(p,[["render",c]]);export{m as __pageData,h as default};
