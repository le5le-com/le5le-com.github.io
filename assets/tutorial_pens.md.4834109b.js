...
</code></pre></div><h3 id="\u7EA6\u5B9A\u56FE\u5F62" tabindex="-1">\u7EA6\u5B9A\u56FE\u5F62 <a class="header-anchor" href="#\u7EA6\u5B9A\u56FE\u5F62" aria-hidden="true">#</a></h3><p>\u7EA6\u5B9A\u5982\u6B64\uFF0C\u5E76\u975E\u5F3A\u5236\u8981\u6C42\u3002</p><table><thead><tr><th>name</th><th>\u63CF\u8FF0</th></tr></thead><tbody><tr><td>text</td><td>\u7EAF\u6587\u672C</td></tr><tr><td>image</td><td>\u7EAF\u56FE\u7247\uFF0C\u7EAF icon</td></tr></tbody></table><h2 id="\u6D41\u7A0B\u56FE" tabindex="-1">\u6D41\u7A0B\u56FE <a class="header-anchor" href="#\u6D41\u7A0B\u56FE" aria-hidden="true">#</a></h2><div class="language-js"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span> flowPens <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@topology/flow-diagram&#39;</span><span class="token punctuation">;</span>
...
topology<span class="token punctuation">.</span><span class="token function">inactive</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div>`,40),e=[o];function c(u,l,r,k,i,d){return a(),s("div",null,e)}var h=n(p,[["render",c]]);export{m as __pageData,h as default};
