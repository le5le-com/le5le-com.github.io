import{_ as n,c as s,o as a,a as t}from"./app.4d5ae0f8.js";const b='{"title":"\u56FE\u8868","description":"","frontmatter":{},"headers":[{"level":2,"title":"lineChart \u6298\u7EBF\u56FE","slug":"linechart-\u6298\u7EBF\u56FE"},{"level":2,"title":"histogram \u67F1\u72B6\u56FE","slug":"histogram-\u67F1\u72B6\u56FE"},{"level":2,"title":"pieChart \u997C\u56FE","slug":"piechart-\u997C\u56FE"},{"level":2,"title":"gauge \u4EEA\u8868\u76D8","slug":"gauge-\u4EEA\u8868\u76D8"},{"level":2,"title":"dashBoard \u4EEA\u8868\u76D8 \u7B80\u7565\u7248","slug":"dashboard-\u4EEA\u8868\u76D8-\u7B80\u7565\u7248"},{"level":2,"title":"\u6570\u636E\u5B9E\u65F6\u66F4\u65B0","slug":"\u6570\u636E\u5B9E\u65F6\u66F4\u65B0"}],"relativePath":"tutorial/charts.md","lastUpdated":1641969166562}',p={},o=t(`<h1 id="\u56FE\u8868" tabindex="-1">\u56FE\u8868 <a class="header-anchor" href="#\u56FE\u8868" aria-hidden="true">#</a></h1><p>\u539F\u751F topology \u56FE\u8868\u63A7\u4EF6\uFF0C\u66F4\u65B9\u4FBF\u7684\u652F\u6301\u539F\u751F\u4EA4\u4E92\u4E8B\u4EF6\u548C\u56FE\u5C42\u3002\u5305\u542B\uFF1A\u6298\u7EBF\u56FE\u3001\u67F1\u72B6\u56FE\u3001\u997C\u56FE\u3001\u4EEA\u8868\u76D8\u7B49\uFF0C\u66F4\u591A\u6B22\u8FCE\u8054\u7CFB\u6211\u4EEC\u3002</p><p>\u6CE8\u610F\uFF1Ale5le charts\u5BF9echarts\u683C\u5F0F\u6570\u636E\u505A\u4E86\u517C\u5BB9\u6027\u5904\u7406\uFF08\u8FC7\u6EE4\u6389\u65E0\u6548\u6570\u636E\uFF09 \u6570\u636E\u683C\u5F0F\u53C2\u8003\uFF1Aecharts\u3002</p><h2 id="linechart-\u6298\u7EBF\u56FE" tabindex="-1">lineChart \u6298\u7EBF\u56FE <a class="header-anchor" href="#linechart-\u6298\u7EBF\u56FE" aria-hidden="true">#</a></h2><ul><li><strong>\u6570\u636E</strong></li></ul><p>\u5F53\u524D\u652F\u6301\u7684\u914D\u7F6E\u5982\u4E0B\uFF1A</p><table><thead><tr><th>\u540D\u79F0</th><th>\u7C7B\u578B</th><th>\u63CF\u8FF0</th></tr></thead><tbody><tr><td>color</td><td>string[]</td><td>\u8C03\u8272\u76D8\u989C\u8272\u5217\u8868</td></tr><tr><td>xAxis.data</td><td>string[]</td><td>\u6A2A\u5750\u6807\u503C</td></tr><tr><td>series[i].data</td><td>number[]</td><td>\u7EB5\u5750\u6807\u6570\u636E\u503C</td></tr><tr><td>series[i].smooth</td><td>boolean</td><td>\u6298\u7EBF\u56FE\u662F\u5426\u5E73\u6ED1</td></tr></tbody></table><ul><li><strong>\u4F7F\u7528</strong></li></ul><div class="language-js"><pre><code><span class="token keyword">const</span> linechart <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
topology<span class="token punctuation">.</span><span class="token function">addPen</span><span class="token punctuation">(</span>dashBoard<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><ol start="2"><li>\u65F6\u949F</li></ol><div class="language-js"><pre><code><span class="token keyword">const</span> clock <span class="token operator">=</span> <span class="token punctuation">{</span>
          name<span class="token operator">:</span> <span class="token string">&#39;dashBoard&#39;</span><span class="token punctuation">,</span>
          x<span class="token operator">:</span> <span class="token number">100</span><span class="token punctuation">,</span>
          y<span class="token operator">:</span> <span class="token number">100</span><span class="token punctuation">,</span>
...
topology<span class="token punctuation">.</span>store<span class="token punctuation">.</span>active<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">.</span>echarts<span class="token punctuation">.</span>option<span class="token punctuation">.</span>series<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">.</span>data <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">20</span><span class="token punctuation">,</span> <span class="token number">932</span><span class="token punctuation">,</span> <span class="token number">901</span><span class="token punctuation">,</span> <span class="token number">34</span><span class="token punctuation">,</span> <span class="token number">1290</span><span class="token punctuation">,</span> <span class="token number">1330</span><span class="token punctuation">,</span> <span class="token number">20</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
topology<span class="token punctuation">.</span><span class="token function">setValue</span><span class="token punctuation">(</span>topology<span class="token punctuation">.</span>store<span class="token punctuation">.</span>active<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre></div>`,33),e=[o];function c(u,l,k,r,i,d){return a(),s("div",null,e)}var g=n(p,[["render",c]]);export{b as __pageData,g as default};
