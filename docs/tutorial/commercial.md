...
| 在线技术支持     | 12 个月                     | 12 个月                      | 3 个月                     |
| 远程培训     | 5 次                       | 8 次                        | 1 次                        |
| 价格             | 高定制化首选 <br />￥ 98000 | 高定制化首选 <br />￥ 128000 | 快速使用首选 <br />￥ 35000 |
...
| 电力图形库一套（约 2000 个）   | ￥ 9900 | 格式：js、iconfont，永久授权 |
| 物联网图形库一套（约 1800 个） | ￥ 9900 | 格式：js、png、gif，永久授权 |
| 预售：2.5D科技风图形库一套（300个） | ￥ 9900 | 格式：js、png、gif，永久授权 |
