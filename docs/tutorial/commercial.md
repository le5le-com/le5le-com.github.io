...
2d可视化组态平台解决方案：https://2ds.le5le.com/search      
...
2、双方签订合同；  
3、甲方付款到乙方指定账户；  
4、乐吾乐可视化组态软件源码版：收到合同款项后乙方1个工作日内交付源码和使用手册，甲方只需提供一个指定 Github 账号，加入到乙方项目团队中，一年内甲方可以随时下载最新企业版源码，同时乙方提供专业技术支持服务。开具增值税专用发票或普票。     
5、安装包版：收到合同款项后，乙方将 授权码 和使用手册发送到甲方指定邮箱，同时提供专业技术支持服务。开具增值税专用发票或普票。   
...
乐吾乐2D可视化后端，主要用于文件保存，详细功能参考[API 接口文档](./commercial-api) 最下面的“后端模块”介绍
...
| --------------------- | ------------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------ |
| 乐吾乐2D可视化              | canvas                    | 拖拽、编辑、动画、事件、交互 | 可支持：<br> 1 万+节点良好（2-3 万也可），1000+动画<br><br>性能瓶颈：<br>图片数量、动画数量                      | 支持 mqtt、websocket、http、api 等实时监听数据 <br><br> 消息监听、鼠标、值变化等交互事件丰富 | 能够快速上手、深入需要学习。良好的开放性。 <br><br> 图形库、算法等可任意扩展 | 核心库meta2d.js开源           |
| G6                    | canvas                    | 拖拽、编辑、动画、事件、交互 | 官方教程：<br> 5000 优异； 1 万良好；2 万略延迟 <br> <br> 用户案例（ http://oxoyo.co/X-Flowchart-Vue/ ） <br>200 | 调用 api 实时监听数据 <br><br> 配合自定义交互可实现丰富的交互事件                            | 能够快速上手、深入需要学习。良好的开放性。 <br><br> 图形库、算法等可任意扩展 | 核心库meta2d.js开源          |
